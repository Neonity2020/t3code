...
import {
  ...
  currentPiAgentModelIdFromSessionSetup,
    ...
    Effect.gen(function* () {
      ...
      const promptResult = yield* Effect.gen(function* () {
        ...
        yield* applyPiAgentAcpModelSelection({
          runtime,
          currentModelId: currentPiAgentModelIdFromSessionSetup(started.sessionSetupResult),
          model: modelSelection.model,
          mapError: ({ cause }) =>
            mapPiAgentAcpError(
              operation,
              "Failed to set Pi Agent ACP base model for text generation.",
              cause,
            ),
        });

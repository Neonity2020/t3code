...
/** The display language is local to each client, like theme and timestamp format. */
export const DisplayLanguage = Schema.Literals(["en", "zh-CN"]);
...
/** Settings for the local Pi coding-agent RPC process. */
